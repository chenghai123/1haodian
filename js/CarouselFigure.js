...
function Banner(json){
	...
	if(typeof this.initUI!="function"){
		Banner.prototype.initUI=function(){
			...
			listObj.style.cssText="position:absolute;bottom:"+0+"px;left:"+this.btnLeft+"px;opacity:0.8;z-index:10;padding:0";
			$A(this.boxId).appendChild(listObj);
			for(var i=0;i<this.imgArr.length;++i){
				var newarr=["猎风超轻跑鞋","跑出清爽","长跑专题","炼与内-型于外"];
				var liObj=document.createElement('li');
				liObj.innerHTML=newarr[i];
				liObj.style.cssText="list-style:none;float:left;height:"+this.btnHeight+"px;width:"+this.btnWidth+"px;background:"+this.btnColor+";margin-left:"+this.btnSpace+"px;line-height:"+41+"px;color:white;font-weight:900;text-align:center;border-radius:";
